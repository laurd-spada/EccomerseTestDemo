      ...
      %>
          <tr>
           ...
           <td><%out.println(sno);%></td>
            ...
            <td><a href="incDecQuantityAction.jsp?id=<%= resultSet1.getString(1)%>&quantity=inc"><i class='fas fa-plus-circle'></i></a><%= resultSet1.getString(8)%>  <a href="incDecQuantityAction.jsp?id=<%= resultSet1.getString(1)%>&quantity=dec"><i class='fas fa-minus-circle'></i></a></td>
